...
const MATERIAS = [
  ...
  { id: "mat-lata", nombre: "Lata / envase", categoria: "Envasado", unidad: "ud", coste_medio: 0.40, disponibilidad_actual: 0, notas: "0,40 € por lata (envase + cierre)" },
];
...
const PRODUCTOS = [
  {
    ...
    descripcion: "Línea fit · lata. PVP 4,90 €. POR UNIDAD: doble espresso de Brasil (17 g de café), 160 ml de leche de avena, 10 g de proteína, + envase (0,40 €). " +
      ...
      "Para 50 latas: 850 g de café, 8 L de leche de avena, 500 g de proteína, 50 latas. El coste real por lata y su food cost se calculan en el módulo Latas fit (fuente única).",
  },
  {
    ...
    descripcion: "Línea fit · lata. PVP 4,90 €. POR UNIDAD: 2 g de matcha, 25 ml de agua filtrada, 160 ml de agua de coco, 5 g de colágeno lima-limón, + envase (0,40 €). " +
      ...
      "Para 50 latas: 100 g de matcha, 1,25 L de agua filtrada, 8 L de agua de coco, 250 g de colágeno, 50 latas. El coste real por lata y su food cost se calculan en el módulo Latas fit (fuente única).",
  },
];
